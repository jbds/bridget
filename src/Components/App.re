...
let make = () => {
  ...
  <div id="sidebar1">
    ...
    <ButtonStdJsx id="btnReviewDeal" label="Review" onClick=handlerBtnReviewDeal isWasteOfSpace={!state.isReviewDealVisible}/>
  </div>
  <div id="sidebar2">
    //(s2e("Sidebar2"))
    <br/>
    //<button id="btn1">(s2e("p5 click listener"))</button>
    <ButtonStd dispatch action=EndTrick label="End Trick" id="btnEndTrick" isVisible=false/>
